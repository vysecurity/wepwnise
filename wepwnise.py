...
"Private Declare PtrSafe Function VirtualFreeEx Lib \"kernel32\" (ByVal hProcess As Long, ByVal lpAddress As Long, ByVal dwSize As Long, ByVal dwFreeType As Long) As LongPtr\r\n",
"Private Declare PtrSafe Function WriteProcessMemory Lib \"kernel32\" (ByVal hProcess As Long, ByVal lpBaseAddress As LongPtr, ByRef lpBuffer As Any, ByVal nSize As Long, ByVal lpNumberOfBytesWritten As LongPtr) As LongPtr\r\n",
"Private Declare PtrSafe Function CreateRemoteThread Lib \"kernel32\" (ByVal hProcess As Long, ByVal lpThreadAttributes As Any, ByVal dwStackSize As Long, ByVal lpStartAddress As LongPtr, lpParameter As Any, ByVal dwCreationFlags As Long, lpThreadId As Long) As LongPtr\r\n",
...
"Private Declare Function VirtualAllocEx Lib \"kernel32\" (ByVal hProcess As Long, ByVal lpAddress As Any, ByVal dwSize As Long, ByVal flAllocationType As Long, ByVal flProtect As Long) As Long\r\n",
...
"Private Declare Function WriteProcessMemory Lib \"kernel32\" (ByVal hProcess As Long, ByVal lpBaseAddress As Any, ByRef lpBuffer As Any, ByVal nSize As Long, ByVal lpNumberOfBytesWritten As Long) As Long\r\n",
